...
/*  `triangleaTREAList':  An array of triangle area constraints; one TREAL per */
/*    triangle.  Input only.                                                 */
...
/*      used (with no number following), `triangleaTREAList' must point to a  */
...
/*      initialized.  `triangleaTREAList' may be ignored.                     */
...
struct triangulateio {
  ...
  TREAL *triangleaTREAList;                                         /* In only */
